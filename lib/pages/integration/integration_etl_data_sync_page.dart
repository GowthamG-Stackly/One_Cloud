...
class IntegrationEtlDataSyncPage extends StatelessWidget {
  const IntegrationEtlDataSyncPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ETL / Data Sync'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.sync_alt_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage extraction, transformation and synchronization jobs.'),
                    ],
                  ),
                ),
              ],
