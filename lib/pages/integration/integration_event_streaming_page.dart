...
class IntegrationEventStreamingPage extends StatelessWidget {
  const IntegrationEventStreamingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Event Streaming'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.stream_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Monitor enterprise event streams and consumers.'),
                    ],
                  ),
                ),
              ],
