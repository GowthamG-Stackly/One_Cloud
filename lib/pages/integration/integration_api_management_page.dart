...
class IntegrationApiManagementPage extends StatelessWidget {
  const IntegrationApiManagementPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.api_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage enterprise APIs, access and lifecycle.'),
                    ],
                  ),
                ),
              ],
