...
class IntegrationThirdPartyIntegrationsPage extends StatelessWidget {
  const IntegrationThirdPartyIntegrationsPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.extension_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage integrations with external business systems.'),
                    ],
                  ),
                ),
              ],
