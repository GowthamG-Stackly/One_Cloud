...
class IntegrationDataTransformationPage extends StatelessWidget {
  const IntegrationDataTransformationPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.transform_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Transform and map data between connected systems.'),
                    ],
                  ),
                ),
              ],
