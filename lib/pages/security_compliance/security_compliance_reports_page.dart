...
class SecurityComplianceReportsPage extends StatelessWidget {
  const SecurityComplianceReportsPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.assignment_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Generate and review enterprise compliance reports.'),
                    ],
                  ),
                ),
              ],
