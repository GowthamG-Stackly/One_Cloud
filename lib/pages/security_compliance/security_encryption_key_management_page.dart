...
class SecurityEncryptionKeyManagementPage extends StatelessWidget {
  const SecurityEncryptionKeyManagementPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.vpn_key_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage encryption controls and cryptographic keys.'),
                    ],
                  ),
                ),
              ],
