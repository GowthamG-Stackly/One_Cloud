...
class SecurityDataRetentionPage extends StatelessWidget {
  const SecurityDataRetentionPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.delete_sweep_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage data retention and deletion policies.'),
                    ],
                  ),
                ),
              ],
