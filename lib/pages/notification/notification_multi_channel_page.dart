...
class NotificationMultiChannelPage extends StatelessWidget {
  const NotificationMultiChannelPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Multi-Channel'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.hub_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Coordinate notifications across multiple channels.'),
                    ],
                  ),
                ),
              ],
