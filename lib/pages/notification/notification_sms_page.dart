...
class NotificationSmsPage extends StatelessWidget {
  const NotificationSmsPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.sms_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage SMS alerts and transactional messages.'),
                    ],
                  ),
                ),
              ],
