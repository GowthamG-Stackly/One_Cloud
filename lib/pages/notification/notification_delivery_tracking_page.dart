...
class NotificationDeliveryTrackingPage extends StatelessWidget {
  const NotificationDeliveryTrackingPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.track_changes_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Track notification delivery and failure status.'),
                    ],
                  ),
                ),
              ],
