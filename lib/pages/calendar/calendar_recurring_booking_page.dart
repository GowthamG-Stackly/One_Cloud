...
class CalendarRecurringBookingPage extends StatelessWidget {
  const CalendarRecurringBookingPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.repeat_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage recurring meetings and bookings.'),
                    ],
                  ),
                ),
              ],
