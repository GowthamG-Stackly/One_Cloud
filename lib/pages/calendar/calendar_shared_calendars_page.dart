...
class CalendarSharedCalendarsPage extends StatelessWidget {
  const CalendarSharedCalendarsPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.share_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage calendars shared across users and teams.'),
                    ],
                  ),
                ),
              ],
