...
class CalendarUserCalendarsPage extends StatelessWidget {
  const CalendarUserCalendarsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('User Calendars'),
      ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage individual user calendars and events.'),
                    ],
                  ),
                ),
              ],
