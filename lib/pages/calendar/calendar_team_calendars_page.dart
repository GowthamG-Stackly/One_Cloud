...
class CalendarTeamCalendarsPage extends StatelessWidget {
  const CalendarTeamCalendarsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Team Calendars'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.groups_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage shared calendars for teams and departments.'),
                    ],
                  ),
                ),
              ],
