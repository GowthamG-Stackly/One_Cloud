...
class CalendarEventNotificationsPage extends StatelessWidget {
  const CalendarEventNotificationsPage({super.key});
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Configure notifications for calendar events and changes.'),
                    ],
                  ),
                ),
              ],
