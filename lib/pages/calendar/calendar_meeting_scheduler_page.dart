...
class CalendarMeetingSchedulerPage extends StatelessWidget {
  const CalendarMeetingSchedulerPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.event_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Schedule meetings and coordinate availability.'),
                    ],
                  ),
                ),
              ],
