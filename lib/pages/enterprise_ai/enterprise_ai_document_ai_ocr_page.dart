...
class EnterpriseAiDocumentAiOcrPage extends StatelessWidget {
  const EnterpriseAiDocumentAiOcrPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Document AI / OCR'),
      ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Process documents and extract information with AI.'),
                    ],
                  ),
                ),
              ],
