...
class EnterpriseAiPromptEngineeringPage extends StatelessWidget {
  const EnterpriseAiPromptEngineeringPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Prompt Engineering'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.code_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage prompts, versions and response quality.'),
                    ],
                  ),
                ),
              ],
