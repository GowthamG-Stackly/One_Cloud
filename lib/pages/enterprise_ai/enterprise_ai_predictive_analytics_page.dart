...
class EnterpriseAiPredictiveAnalyticsPage extends StatelessWidget {
  const EnterpriseAiPredictiveAnalyticsPage({super.key});
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Use AI models to forecast outcomes and trends.'),
                    ],
                  ),
                ),
              ],
