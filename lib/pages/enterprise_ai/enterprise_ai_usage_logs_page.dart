...
class EnterpriseAiUsageLogsPage extends StatelessWidget {
  const EnterpriseAiUsageLogsPage({super.key});
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Review AI requests, usage and operational activity.'),
                    ],
                  ),
                ),
              ],
