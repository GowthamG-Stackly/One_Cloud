...
class EnterpriseAiModelManagementPage extends StatelessWidget {
  const EnterpriseAiModelManagementPage({super.key});
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage AI model lifecycle and deployments.'),
                    ],
                  ),
                ),
              ],
