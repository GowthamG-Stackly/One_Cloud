...
class EnterpriseAiRecommendationsPage extends StatelessWidget {
  const EnterpriseAiRecommendationsPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.recommend_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage AI-powered recommendations.'),
                    ],
                  ),
                ),
              ],
