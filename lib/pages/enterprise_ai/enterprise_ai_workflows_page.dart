...
class EnterpriseAiWorkflowsPage extends StatelessWidget {
  const EnterpriseAiWorkflowsPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.account_tree_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Configure AI-powered business workflows.'),
                    ],
                  ),
                ),
              ],
