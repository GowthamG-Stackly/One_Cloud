...
class EnterpriseAiModelsPage extends StatelessWidget {
  const EnterpriseAiModelsPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.model_training_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage enterprise AI models and model availability.'),
                    ],
                  ),
                ),
              ],
