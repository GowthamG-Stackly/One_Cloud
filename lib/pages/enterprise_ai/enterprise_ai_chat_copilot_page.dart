...
class EnterpriseAiChatCopilotPage extends StatelessWidget {
  const EnterpriseAiChatCopilotPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AI Chat / Copilot'),
      ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage AI assistants and enterprise copilots.'),
                    ],
                  ),
                ),
              ],
