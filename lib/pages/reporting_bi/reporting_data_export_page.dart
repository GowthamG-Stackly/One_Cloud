...
class ReportingDataExportPage extends StatelessWidget {
  const ReportingDataExportPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.file_download_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Export report and analytical data for business use.'),
                    ],
                  ),
                ),
              ],
