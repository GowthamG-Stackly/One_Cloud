...
class ReportingDataExplorationPage extends StatelessWidget {
  const ReportingDataExplorationPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Data Exploration'),
      ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Explore enterprise datasets and discover insights.'),
                    ],
                  ),
                ),
              ],
