...
class ReportingStandardReportsPage extends StatelessWidget {
  const ReportingStandardReportsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Standard Reports'),
      ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage predefined enterprise reports.'),
                    ],
                  ),
                ),
              ],
