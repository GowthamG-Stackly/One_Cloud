...
class SearchMultiTenantIndexPage extends StatelessWidget {
  const SearchMultiTenantIndexPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Multi-Tenant Index'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.domain_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage isolated search indexes across tenants.'),
                    ],
                  ),
                ),
              ],
