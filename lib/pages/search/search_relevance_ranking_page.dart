...
class SearchRelevanceRankingPage extends StatelessWidget {
  const SearchRelevanceRankingPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Relevance Ranking'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.sort_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Configure ranking and result relevance rules.'),
                    ],
                  ),
                ),
              ],
