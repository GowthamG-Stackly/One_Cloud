...
class SearchSynonymsPage extends StatelessWidget {
  const SearchSynonymsPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.spellcheck_outlined, size: 32),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Manage synonyms and equivalent search terms.'),
                    ],
                  ),
                ),
              ],
